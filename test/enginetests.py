...
class EngineTest(unittest.TestCase):
    ...
    def test_calculation(self):
        resultsA = engine.results(self.calculationgroup, 'A', ('A', 'B', 'C'))
        ...
        resultsB = engine.results(self.calculationgroup, 'B', ('A', 'B', 'C'))
        ...
        resultsC = engine.results(self.calculationgroup, 'C', ('A', 'B', 'C'))
